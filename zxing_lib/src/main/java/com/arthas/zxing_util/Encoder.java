...
public final class Encoder
{
    ...
    public Bitmap encodeBar(final String content){
    ...
    public static String formatBarCode(String code)
    {
        ...
        for ( int i = 0; i < spanCount; i++ )
        {
            ...
            {
                buffer.append(code.subSequence(i * span, span * (i + 1)) + "  ");
            }
        }
     ...
     * @return Bitmap对象，如果生成失败，返回null。
     */
    public Bitmap encode(final String content, int width, int height, BarcodeFormat format){
